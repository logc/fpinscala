...
object PolymorphicFunctions {
  ...
  def isSorted[A](as: Array[A], gt: (A,A) => Boolean): Boolean = {
    ...
    !pairs.exists { case (a1, a2) => !gt(a1, a2) }
  }

  def main(args: Array[String]): Unit = {
    println("is (3, 2, 1) sorted? %s".format(isSorted(Array(3, 2, 1), (x1: Int, x2: Int) => x1 > x2)))
    println("is (3, 1, 2) sorted? %s".format(isSorted(Array(3, 1, 2), (x1: Int, x2: Int) => x1 > x2)))
  }
